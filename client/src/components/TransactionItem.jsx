      ...
      >
        ...
        {!tx.settled && isUserInvolved && (
          <button
            ...
            className="bg-[#FCF5E5] border-l-2 border-t-2 border-r-4 border-b-4 border-black text-black px-3 sm:px-4 py-2 rounded-md text-sm sm:text-base font-semibold shadow-sm hover:brightness-110 transition-all duration-300 w-full sm:w-auto"
          >
            Settle
          </button>
        )}
