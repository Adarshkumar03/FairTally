    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-[rgba(0,0,0,0.3)]">
            <div className="bg-[#FFF6E5] w-[400px] max-h-[500px] p-6 rounded-lg shadow-lg relative">
                <h2 className="text-2xl font-bold mb-4 text-center text-[#030303]">Add Users to Group</h2>
                ...
                <div className="max-h-60 overflow-y-auto bg-[#F7C236] p-3 rounded-md">
                    {users.length === 0 ? (
                        <p className="text-gray-700 text-sm text-center">No users available to add.</p>
                    ) : (
